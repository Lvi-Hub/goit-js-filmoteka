...
//    return await axios.get(`${BASE_URL}discover/movie?api_key=${API_KEY}&${POPULAR_MOVIES}&page=${pageNumber}`)
//    }
...
//       itemsPerPage: 20,
//       centerAlign: true,
//       totalItems: movies.data.total_results,
//       visiblePages: 7,
//     }
...
//     //  pagination.setTotalItems(movies.data.total_results);
//       filmsListEl.innerHTML = makeMarkupPopularMov(movieData);
//      addEventlListenertoFilmCard();
